...
export default interface AnchorLayout extends Omit<Layout, 'props' | 'type'> {
    props: {
        ...
        // Anchor accept an anchoring-specific config property of anchor which is a string containing two values: the
